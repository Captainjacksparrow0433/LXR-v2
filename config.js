...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Jack' : process.env.ALL_CAPTION,
    OWNER: process.env.OWNER_NAME === undefined ? 'default' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+919061103727' : process.env.NUMBER,   
    ABIN: process.env.DEPLOYER === undefined ? 'ᴀʙɪɴ ' : process.env.DEPLOYER,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/df220686268d9ab7badfe.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Jack' : process.env.LOGO_NAME,
    MENTION: process.env.TAG_REPLY === undefined ? '919061103727@s.whatsapp.net' : process.env.TAG_REPLY, 
    ABIN_SER: process.env.FIRST_BOTTON === undefined ? 'Hello' : process.env.FIRST_BOTTON,
    ABIN_SIR: process.env.SECOND_BOTTON === undefined ? 'Hii' : process.env.SECOND_BOTTON,   
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'Abin' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://telegra.ph/file/df220686268d9ab7badfe.jpg' : process.env.ALL_IMG,
    ...
    ALIVETYPE: process.env.ALIVE_TYPE === undefined ? 'one' : process.env.ALIVE_TYPE,
